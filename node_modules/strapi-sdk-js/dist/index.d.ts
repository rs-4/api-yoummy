...
type StrapiUser = Record<string, unknown> | null;
...
declare class Strapi {
     ...
     * @returns Promise<StrapiAuthenticationResponse>
     */
    changePassword(data: StrapiChangePasswordData): Promise<StrapiAuthenticationResponse>;
    /**
...
export { PaginationByOffset, PaginationByPage, StoreConfig, StrapiAuthProvider, StrapiAuthenticationData, StrapiAuthenticationResponse, StrapiBaseRequestParams, StrapiChangePasswordData, StrapiDefaultOptions, StrapiEmailConfirmationData, StrapiError, StrapiForgotPasswordData, StrapiLocale, StrapiOptions, StrapiRegistrationData, StrapiRequestParams, StrapiResetPasswordData, StrapiResponse, StrapiUser, Strapi as default };
